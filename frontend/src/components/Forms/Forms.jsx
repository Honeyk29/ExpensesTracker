    ...
    return (
        <FormStyled onSubmit={handleSubmit}>
            ...
            <div className="selects input-control">
                <select required name="catergory" id="category" value = {category} onChange={handleInput('category')}>
            ...
            <div className="input-control">
                <textarea name="description" value={description} cols="30" rows="4" placeholder='Type the description'  onChange={handleInput('description')}></textarea>
            </div>
